...
abstract class ScreenLifecycleTask {
    ...
    */
    ...
    /*
    * Callback received when a Screen is destroyed and wil not be coming back (except new instance). This should be used to dispose any {@link ActivityScope} connections
    */
    open fun onDestroy() {}
}
