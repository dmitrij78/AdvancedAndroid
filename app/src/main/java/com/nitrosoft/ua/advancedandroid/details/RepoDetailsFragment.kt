...
class RepoDetailsFragment : BaseFragment() {
    ...
    private val binding: ScreenRepoDetailsBinding = _binding!!
        ...
        return arrayListOf(viewModel.details()
                ...
                .subscribe { details ->
                    if (details.loading) {
                        ...
                        binding.content.visibility = View.GONE
                        binding.content.visibility = if (details.isSuccess()) View.VISIBLE else View.GONE
                        binding.tvError.visibility = if (details.isSuccess()) View.GONE else View.VISIBLE
                ...
                .subscribe { contributorsDetails ->
                    if (contributorsDetails.loading) {
                        ...
                        binding.contributorList.visibility = if (contributorsDetails.isSuccess()) View.VISIBLE else View.GONE
                        binding.tvContributorsError.visibility = if (contributorsDetails.isSuccess()) View.GONE else View.VISIBLE
